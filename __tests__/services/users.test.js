...
const onDisconnectUserData = {
  userId: generalUserId, socketId: undefined, page: 'kein',
};
...
describe('Authorize', () => {
  ...
  it('Should authorize on another site\'s page. isUserExist === true', async () => {
    const result = await authorize(duplicateUserData);
  ...
  it('Should authorize on Diconnect. isUserExist === true', async () => {
